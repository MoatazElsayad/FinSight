...
#include <memory>
#include "../../../src/gui/transactions/TransactionDialog.h"
...
namespace {
struct qt_meta_stringdata_TransactionDialog_t {
    uint offsetsAndSizes[2];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_TransactionDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_TransactionDialog_t qt_meta_stringdata_TransactionDialog = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_TransactionDialog[] = {
...
Q_CONSTINIT const QMetaObject TransactionDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_TransactionDialog.offsetsAndSizes,
    qt_meta_data_TransactionDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_TransactionDialog_t,
        // Q_OBJECT / Q_GADGET
...
void *TransactionDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TransactionDialog.stringdata0))
