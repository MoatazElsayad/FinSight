...
#include <memory>
#include "../../../src/gui/profile/ProfileWindow.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ProfileWindow_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ProfileWindow_t qt_meta_stringdata_ProfileWindow = {
    {
        QT_MOC_LITERAL(0, 13),  // "ProfileWindow"
        QT_MOC_LITERAL(14, 14),  // "profileUpdated"
        QT_MOC_LITERAL(29, 0)   // ""
    },
    "ProfileWindow",
    "profileUpdated",
...
Q_CONSTINIT static const uint qt_meta_data_ProfileWindow[] = {
...
Q_CONSTINIT const QMetaObject ProfileWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ProfileWindow.offsetsAndSizes,
    qt_meta_data_ProfileWindow,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ProfileWindow_t,
        // Q_OBJECT / Q_GADGET
...
void ProfileWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ProfileWindow::profileUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ProfileWindow::profileUpdated()
{
